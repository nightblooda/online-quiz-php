...
include_once 'dbConnection.php';
echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="account.php?q=1" class="log log1">'.$name.'</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log">Logout</button></a></span>';
}?>
</div>
</div></div>
<div class="bg">
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>Moodle</b></a>
    </div>
...
<td><b><a href="#" class="pull-right btn sub1" style="margin:0px;background:red"><b>Submitted</b></a></b></td></tr>';
